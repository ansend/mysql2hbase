...
./jdk1.7.0_79/bin/java -cp ./java:./java/lib/mysql-connector-java-5.1.39/*:./java/lib/hbase-0.98.17_lib/*  Mysql2HbaseCopy ${port} ${tblname} ${dbpass} >./log/$log_file 2>&1 

echo "$?" > ./log/ret_${port}_${tblname}
